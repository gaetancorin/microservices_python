...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\gaeta\Desktop\microservices_python\docker-flask'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\gaeta\Desktop\microservices_python\docker-flask\Scripts\deactivate.nu'
